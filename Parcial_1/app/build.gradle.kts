...
android {
    ...
    compileSdk = 36 // Cambié a 34 (Android 14) porque el SDK 36 aún es experimental
    ...
    defaultConfig {
        ...
        externalNativeBuild {
            cmake {
                ...
                arguments.add("-DOpenCV_DIR=/home/daniel-reyes/Documentos/Universidad/8v0/Vision_por_computadores/opencv-4.12.0-android-sdk/OpenCV-android-sdk/sdk/native/jni")
